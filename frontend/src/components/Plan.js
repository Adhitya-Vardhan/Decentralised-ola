  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        <h3 className="text-5xl md:text-6xl font-bold">Book your Ride</h3>
        <p className="text-2xl py-6">
          Your ride, your choice. Decentralized ridesharing for a fairer future.
        </p>
        <p className="pb-6">
          Enter your source and destination location , put it on to the chain
          ...wait for drivers to pick up the request . if picked up move on, if
          they arrive late pay less, no loss of money, no delay only fairer
          rules
        </p>
        <div>
